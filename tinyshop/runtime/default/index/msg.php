...
<div style="margin:60px  auto; text-align:center; ">
	<div class="message" >
		<div class="header"><i class="<?php echo isset($type)?$type:"";?>"></i><span>提示</span></div>
		<div class="main">
...
<script type="text/javascript">
	$("#timmer").countdown({end_time:"<?php echo date('Y/m/d H:i:s',strtotime('+6 second',time()));?>",format:'{s}秒后自动跳转，请稍后...',callback:function(){
		location.href="<?php echo urldecode(Url::urlFormat("$redirect"));?>";
	}
});
</script>
<?php }?>
