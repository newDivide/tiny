...
<link type="text/css" rel="stylesheet" href="<?php echo urldecode(Url::urlFormat("#js/stars/stars.css"));?>" />
<script type='text/javascript' src="<?php echo urldecode(Url::urlFormat("#js/stars/stars.js"));?>"></script>
<div class="container">
    <div class="layout-2col mt20 clearfix" >
        <div class="sidebar">
            <div class="box">
                ...
                <div  style="width: 200px; padding:15px;" >
                    <img class="big-pic" width="200px"  src="<?php echo urldecode(Url::urlFormat("@$review[img]"));?>" source="<?php echo urldecode(Url::urlFormat("@$review[img]"));?>">
                    <h1><a href="<?php echo urldecode(Url::urlFormat("/index/product/id/$review[gid]"));?>"><?php echo isset($review['name'])?$review['name']:"";?></a></h1>
                    <p>销售价：<b class="red"><?php echo isset($currency_symbol)?$currency_symbol:"";?><?php echo isset($review['sell_price'])?$review['sell_price']:"";?></b></p>
                    <p class="tc"><a href="<?php echo urldecode(Url::urlFormat("/index/product/id/$review[gid]"));?>" class="btn btn-main" target="_blank">前去购买</a></p>
                </div>
        ...
        <div class="content">
            <div class="spec-info mt10 clearfix">
                ...
                <form action="<?php echo urldecode(Url::urlFormat("/"));?>" method="post ">
                    <input type="hidden" name="con" value="index">
...
<script type="text/javascript">
    $(function(){
        var options = {
            max : 5,
            image:'<?php echo urldecode(Url::urlFormat("#js/stars/stars.jpg"));?>',
            imageAll:'<?php echo urldecode(Url::urlFormat("#js/stars/stars-all.gif"));?>',
