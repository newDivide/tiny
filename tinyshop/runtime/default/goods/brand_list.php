...
<div class="tools_bar">
    ...
    <a  class="icon-remove-2" href="javascript:;" onclick="tools_submit({action:'<?php echo urldecode(Url::urlFormat("/goods/brand_del"));?>',msg:'删除后无法恢复，你真的删除吗？'})" title="删除"><i>删除</i></a>
    </a>
    <a href='<?php echo urldecode(Url::urlFormat("/goods/brand_edit"));?>' class="icon-plus" > 添加</a>
</div>
<table class="default">
    <tr>
    ...
    <?php $item=null; $obj = new Query("brand");$obj->page = "1";$obj->order = "id desc";$items = $obj->find(); foreach($items as $key => $item){?>
        <tr><td><input type="checkbox" name="id[]" value="<?php echo isset($item['id'])?$item['id']:"";?>"></td>
        <td style="width:70px" class="btn_min"><div class="operat hidden"><a  class="icon-cog action" href="javascript:;"> 处理</a><div class="menu_select"><ul>
                <li><a class="icon-pencil" href="<?php echo urldecode(Url::urlFormat("/goods/brand_edit/id/$item[id]"));?>"> 编辑</a></li>
                <li><a class="icon-remove-2" href="javascript:confirm_action('<?php echo urldecode(Url::urlFormat("/goods/brand_del/id/$item[id]"));?>')"> 删除</a></li>
               </ul></div></div></td>
        <td><?php echo isset($item['name'])?$item['name']:"";?></td><td><?php echo isset($item['url'])?$item['url']:"";?></td><td> <?php if($item['logo']){?><img src="<?php echo urldecode(Url::urlFormat("@$item[logo]"));?>" height="30px;"><?php }?></td></tr>
    <?php }?>
</table>
</form>
<div class="page_nav">
