...
<div class="tools_bar clearfix">
    <a href='<?php echo urldecode(Url::urlFormat("/content/category_edit"));?>' class="icon-plus" > 添加</a>
</div>
<table class="default">
    <tr>
    ...
    <?php $query = new Query("category");$query->order = "path,sort desc";$items = $query->find();?>
    <?php $category_name=array();?>
    <?php foreach($items as $key => $item){?>
        <?php $category_name[$item['id']]=$item['name'];?>
    <?php }?>
    <?php $category_name[0]='无';?>
    <?php foreach($category as $key => $item){?>
        ...
        <td style="width:70px" class="btn_min"><div class="operat hidden"><a  class="icon-cog action" href="javascript:;"> 处理</a><div class="menu_select"><ul>
                    <li><a class="icon-pencil" href="<?php echo urldecode(Url::urlFormat("/content/category_edit/id/$item[id]"));?>"> 编辑</a></li>
                    <li><a class="icon-remove-2" href="javascript:confirm_action('<?php echo urldecode(Url::urlFormat("/content/category_del/id/$item[id]"));?>');"> 删除</a></li>
                </ul></div></div> </td>
                <td><?php echo str_repeat('— ',count(explode(',',$item['path']))-3);?><?php echo isset($item['name'])?$item['name']:"";?></td><td><?php echo isset($category_name[$item['parent_id']])?$category_name[$item['parent_id']]:"";?></td><td style="width:100px;"><?php echo isset($item['alias'])?$item['alias']:"";?></td><td style="width:70px;"><?php echo isset($item['sort'])?$item['sort']:"";?></td></tr>
    <?php }?>
</table>
	</div>
</div>
