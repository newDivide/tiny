...
<div class="tools_bar clearfix">
    ...
    <a href='<?php echo urldecode(Url::urlFormat("/admin/manager_edit"));?>' class="icon-plus" > 添加</a>
</div>
<table class="default" >
    <tr>
    ...
    <?php $item=null; $obj = new Query("manager as ma");$obj->fields = "ma.*,ro.name as rname";$obj->join = "left join roles as ro on ma.roles = ro.id";$obj->page = "1 desc";$items = $obj->find(); foreach($items as $key => $item){?>
        <tr><td style="width:30px"><input type="checkbox" name="id[]" value="<?php echo isset($item['id'])?$item['id']:"";?>"></td>
        <td style="width:70px" class="btn_min"><div class="operat hidden"><a  class="icon-cog action" href="javascript:;"> 处理</a><div class="menu_select"><ul>
                    <li><a class="icon-pencil" href="<?php echo urldecode(Url::urlFormat("/admin/manager_edit/id/$item[id]"));?>"> 编辑</a></li>
                    <li><a class="icon-close" href="javascript:confirm_action('<?php echo urldecode(Url::urlFormat("/admin/manager_del/id/$item[id]"));?>')"> 删除</a></li>
                </ul></div></div> </td>
        <td style="width:100px"><?php echo isset($item['name'])?$item['name']:"";?></td><td style="width:100px"><?php if($item['roles']=='administrator'){?>超级管理员<?php }else{?><?php echo isset($item['rname'])?$item['rname']:"";?><?php }?></td><td ><?php echo isset($item['last_ip'])?$item['last_ip']:"";?></td><td  ><?php echo isset($item['last_login'])?$item['last_login']:"";?></td><td style="width:60px"><?php echo $item['is_lock']==0?"正常":"锁定";?></td></tr>
    <?php }?>
</table>
</form>
<div class="page_nav">
