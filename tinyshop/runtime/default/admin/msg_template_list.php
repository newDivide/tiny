...
<table class="default" >
    ...
    <?php $item=null; $obj = new Query("msg_template");$obj->page = "1 desc";$items = $obj->find(); foreach($items as $key => $item){?>
        <tr><td ><?php echo isset($item['name'])?$item['name']:"";?></td><td style="width:100px" class="btn_min"><a class="icon-pencil" href="<?php echo urldecode(Url::urlFormat("/admin/msg_template_edit/id/$item[id]"));?>"> 编辑</a></td></tr>
    <?php }?>
</table>
</form>
<div class="page_nav">
