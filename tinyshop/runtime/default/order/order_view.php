...
<div style="overflow: auto;width:900px;height: 450px;">
	...
	<table class="default">
		...
		<table class="default">
		<tr><th width="100"><b class="red">*</b>收货人姓名：</th><td><?php echo isset($item['accept_name'])?$item['accept_name']:"";?></td><th width="100"><b class="red">*</b>联系手机：</th><td><?php echo isset($item['mobile'])?$item['mobile']:"";?></td></tr>
		<tr><th>联系电话：</th><td><?php echo isset($item['phone'])?$item['phone']:"";?></td><th>邮编：</th><td><?php echo isset($item['zip'])?$item['zip']:"";?></td></tr>
		...
		<tr><th><b class="red">*</b>收货地址：</th><td colspan=3><?php echo isset($item['addr'])?$item['addr']:"";?></td></tr>
		</table>
		<?php }?>
