...
<div class="container clearfix">
	...
	<div class="clearfix uc-content">
		<h1 class="title"><span>商品咨询：</span></h1>
		<div class="tab">
			<ul class="tab-head">
				<li>已经答复咨询<i></i></li>
				<li>未答复咨询<i></i></li>
			</ul>
			<div class="tab-body ucenter">
				<div id="consult-y" class="clearfix js-template">
					<div class="page-nav"></div>
					<div class="page-content consult-item">
                        <div class="consult-q">
                            <div class="head">
                                <img  src="<?php echo urldecode(Url::urlFormat("@$user[head_pic]"));?>" style="width:80px;height:80px;">
                                <strong>我</strong>
                                <i class="arrow"><b></b></i>
                            </div>
                            <div class="consult-content consult-goods">
                            <a class="goods-img" href="<?php echo urldecode(Url::urlFormat("/index/product/id/"));?>{gid}" target="_blank"><img src="{img}" width="100" height="100"></a>
                            <p class="title"> <a href="<?php echo urldecode(Url::urlFormat("/index/product/id/"));?>{gid}" target="_blank">{name}</a>   价格：<b class="red"><?php echo isset($currency_symbol)?$currency_symbol:"";?>{sell_price}</b></p>
                            {question}
                                <p class="tr">{ask_time}</p>
                            </div>
                        </div>
                        <div class="consult-a {question||hidden} ucenter-a" >
                            <div class="head">
				...
				<div id="consult-n" class="js-template clearfix">
					<div class="page-nav"></div>
...
<script type="text/javascript">
	$("#consult-n").Paging({
		url:'<?php echo urldecode(Url::urlFormat("/ucenter/get_consult"));?>',
		params:{status:'n'}
	});
	$("#consult-y").Paging({
		url:'<?php echo urldecode(Url::urlFormat("/ucenter/get_consult"));?>',
